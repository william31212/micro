...
unsigned int stu[2][8] = {{Number_4, Number_0, Number_6, Number_2, Number_6, Number_2, Number_2, Number_9},
								{Number_4, Number_0, Number_5, Number_2, Number_9, Number_0, Number_2, Number_9}};
...
int main()
{
	...
	while(1)
	{
		tmp = (GPIO_PTC_PADIN >> 2) & 0x00000003;
